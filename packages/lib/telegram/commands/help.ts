...
export default async function runHelpCommand({ chat }: Message) {
  const message =
    'Help for <i>Krypto Swap bot</i>.%0AUse /set_percent <i>command</i> to setup <i>percent for calculator</i> in your web-page.%0A<b>Example for 3%:</b> %0A/set_percent 0.03';
